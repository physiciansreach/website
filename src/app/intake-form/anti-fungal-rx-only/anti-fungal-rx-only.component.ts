...
export class AntiFungalRxOnlyComponent implements OnInit {
  ...
  initQuestions() {
    this.questions.push(this.initQuestion('1', 'Where is your skin issue located?'));
    this.questions.push(this.initQuestion('2', 'How long have you had this skin issue?'));
    this.questions.push(this.initQuestion('3', 'Have you treated the skin irritation before?'));
  }
